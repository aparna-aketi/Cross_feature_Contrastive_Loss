...
parser.add_argument('--lambda_m', dest='lambda_m',
                    help='The directory used to save the trained models',
                    default=0.1, type=float)
...
if args.save_dir is None:
    if args.norm is not None:
        args.save_dir = args.arch+"_nodes_"+str(args.world_size)+"_"+ args.norm+"_lr_"+ str(args.lr)+"_lm_"+str(args.lambda_m)+"_skew_"+str(args.skew)+"_"+args.graph
